...
const Form = () => {
  ...
  return (
    <div className="relative flex justify-center items-center mt-8 min-h-screen">
        <div className="min-h-screen absolute inset-0" style={{backgroundImage: `url(${url})`}}></div>
        <form onSubmit={handleSubmit}
            className="bg-white/30 backdrop-blur-md border border-white/30 rounded-xl p-6 flex flex-col gap-4 w-full max-w-md"
        >
